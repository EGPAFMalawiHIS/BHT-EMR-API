...
module ArtService
  class LabTestsEngine
    ...
    def print_order_label(accession_number)
      ...
      { zpl: auto12epl.generate_epl(patient_name.given_name, patient_name.family_name, order.patient_id.to_s,
    ...
    def find_lab_encounter(patient, date)
      ...
      encounter = Encounter.where(patient:, program: @program).where("encounter_datetime BETWEEN ? AND ?", start_time, end_time).last
