  ...
  module V1
    class ReportsController < ApplicationController
      ...
      def nid_utilization_report
        start_date, end_date, site_id = params.require %i[start_date end_date site_id]
        stats = service.nid_utilization_report(start_date:, end_date:, site_id:)
      ...
      def missed_appointments
        start_date, end_date = params.require %i[start_date end_date]
        stats = service.missed_appointments(start_date, end_date, occupation: params[:occupation], site_id: params[:site_id], dsd: params[:dsd])
      ...
      def regimen_report
        render json: service.regimen_report(params[:start_date], params[:end_date], params[:type],
                                            occupation: params[:occupation], site_id: params[:site_id], dsd: params[:dsd])
      end
      ...
      def clients_due_vl
        render json: service.clients_due_vl(params[:start_date], params[:end_date], occupation: params[:occupation], site_id: params[:site_id], dsd: params[:dsd])
      end
      ...
      def lab_test_results
        render json: service.lab_test_results(params[:start_date], params[:end_date], occupation: params[:occupation], 
          site_id: params[:site_id], dsd: params[:dsd])
      end
