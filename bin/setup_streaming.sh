...
# pass environment as an argument to the script
ENV=$1
...
# run streaming:setup task and show output
echo "Running streaming:setup task..." 1>&2
RAILS_ENV=$ENV rails streaming:setup